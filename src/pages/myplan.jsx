        ...
        {plannedPlans.map(plan => (
          <div key={plan.id} className="card" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
              ...
              <p style={{ color: '#666', fontSize: '14px' }}>📅 {plan.planDate} • {plan.duration}</p>
      ...
      {completedPlans.length > 0 && (
        <div>
          ...
          {completedPlans.map(plan => (
            <div key={plan.id} className="card" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', opacity: '0.7' }}>
              <div>
